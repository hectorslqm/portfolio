...
const GitCard: React.FC<{ props: Repository }> = ({ props }) => {
  return (
    <div className="bg-slate-200 rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 hover:scale-105 flex flex-col h-full">
      <div className="p-4 flex-grow">
        <h3 className="text-xl font-bold text-gray-900 mb-2">{props.title}</h3>
        <p className="text-gray-600 mb-4">{props.description}</p>
      </div>
      <div className="flex bg-teal-400 p-2 justify-between mt-auto">
