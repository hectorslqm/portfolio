...
function Navbar() {
    return (
        <nav id="navbar" className="border-yellow-500 mt-2 border-2 rounded-3xl mt- fixed w-full max-w-[110rem] left-1/2 transform -translate-x-1/2 p-4 flex flex-wrap shadow-xl backdrop-blur-sm z-50 bg-gray-900/90">
            {/* Large Screen*/}
