...
export default function Contact() {
  ...
  return (
    <div className="flex items-center justify-center">
      {/* Business Card */}
      <div className="w-full max-w-lg rounded-xl border-4 border-teal-600 bg-slate-200 shadow-2xl overflow-hidden transform transition-transform hover:scale-105 duration-500">
        ...
        <div className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-teal-600 text-lg">Full Stack Developer</p>
          ...
          <div className="space-y-4 mb-8">
            {/* Phone */}
            <div className="flex items-center space-x-4 text-slate-300 hover:text-teal-400 transition-colors duration-300">
            ...
            <div className="grid grid-cols-3 md:grid-cols-7 gap-2">
              {technologies.map((tech, index) => (
                <div key={index} className="flex flex-col items-center w-12 h-12 rounded-full justify-center mb-2 bg-slate-900">
                    {/* This is where you'll put your actual tech icons */}
                    <img 
                      src={Tags[tech.name]} 
                      alt={tech.name} 
                      className="w-8 h-8"
