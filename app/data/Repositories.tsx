...
export const Repositories: RepositoriesType = [
  {
    title: "Portfolio",
    description:
      "This website I made to show my profile. I used NextJS, Typescript and Tailwind",
  ...
  },
  {
    ...
    description:
      "A simple authentication system using NodeJS, MongoDB, Express, JWT and BCrypt",
  ...
  },
  {
    title: "Custom ORM",
    description:
      "An ORM made with Python, that can connect to PostgreSQL and SQLServer",
  ...
  },
  {
    title: "Configure WSL",
    description:
      "I use this project to setup my entire WSL Environment with bash scripts",
  ...
  },
  {
    title: "UDP Listener",
    description:
      "This script creates multiple threads to listen to UDP packets, decodes them and prints them",
  ...
  },
  {
    ...
    description:
      "This project is a simple mortgage calculator application designed to help users estimate their monthly mortgage payments based on loan amount, interest rate, and loan term. It serves as a practical tool for financial planning and understanding mortgage options.",
    url: "https://github.com/hectorslqm/MortgageCalculator",
    tags: ["Java"],
    type: "public",
  },
];
